...
```
Als technieker
wil ik aanbevolen overstromingstools kunnen zien tijdens risicoperiodes
zodat ik snel kan reageren zonder zelf te hoeven zoeken.
```

**Acceptatiecriteria:**

- Given: het huidige seizoen heeft een hoog of gemiddeld overstromingsrisico
- When: ik de materiaallijst of het dashboard open
- Then: verschijnen flood-gerelateerde tools bovenaan de materiaallijst met een visuele markering, en als aparte sectie onderaan het dashboard

- Given: het risico is laag
- When: ik de materiaallijst of het dashboard open
- Then: worden flood tools niet speciaal geprioriteerd en verschijnt er geen flood tools sectie
...
- When: de pagina laadt
- Then: zie ik per seizoen het voorspelde risiconiveau voor het huidig jaar en de komende 5 jaar
...
- Then: verschijnt het nieuwe materiaal in de catalogus en toont het systeem een bevestiging

- Given: ik een naam invul die al bestaat in de actieve catalogus
- When: ik probeer op te slaan
- Then: toont het systeem een waarschuwing "Materiaal met deze naam bestaat al."
...
- When: ik de verwijdering bevestig in het bevestigingsvenster
- Then: verdwijnt het materiaal uit de actieve catalogus en toont het systeem een bevestiging
