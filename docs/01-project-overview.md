...
2. Een forecast kunnen raadplegen voor het huidig jaar en de komende 5 jaar
...
- groepeert neerslag per seizoen en berekent de totale seizoensneerslag per jaar
- berekent een trendlijn via lineaire regressie
- voorspelt overstromingsrisico's voor het huidig jaar en de komende 5 jaar
...
- worden relevante flood tools bovenaan de materiaallijst geplaatst met een visuele markering
- toont het dashboard een flood tools sectie bij het geselecteerde seizoen
