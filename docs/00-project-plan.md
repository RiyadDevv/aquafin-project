...
| Testing Complete | Alle 16 testcases uitgevoerd en gedocumenteerd - 16/16 geslaagd |
...
| Dev Server | Nodemon | Automatisch herstarten van de backend bij wijzigingen (`npm start`) |
...
De applicatie moet:
- een overzicht tonen van overstromingsrisico's voor het huidig jaar en de komende 5 jaar op basis van historische neerslagdata
